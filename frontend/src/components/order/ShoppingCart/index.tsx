...
export function ShoppingCart({ extraClass, label }: Props) {
   ...
   return (
      <button id='shopping-cart' className={`${extraClass} ${Styles['cart-button']}`} aria-label={label} onClick={() => setIsOpen(!isOpen)}>

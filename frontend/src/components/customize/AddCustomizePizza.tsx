...
export function AddCustomizePizza({
	t,
	localForModalLinks,
	pizza,
	characteristics,
		...
		<>
			...
			<SmallModalContainer ref={dialogRef}>
				<>
					...
					<a
						className={PRIMARY__BUTTON}
						href={getRelativeLocaleUrl(localForModalLinks, 'menu')}
					>
						{t.dialog.keepOrdering}
					</a>
					<a
						className={SECONDARY__BUTTON}
						href={getRelativeLocaleUrl(localForModalLinks, 'checkout')}
					>
						{t.dialog.checkout}
					</a>
				</>

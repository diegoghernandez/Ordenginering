...
(UUID(), (SELECT id_pizza FROM pizza WHERE pizza_name = 'Custom something 1' LIMIT 1), 1, 'NORMAL'),
(UUID(), (SELECT id_pizza FROM pizza WHERE pizza_name = 'Custom something 1' LIMIT 1), 2, 'NORMAL'),
(UUID(), (SELECT id_pizza FROM pizza WHERE pizza_name = 'Custom something 2' LIMIT 1), 2, 'NORMAL'),
(UUID(), (SELECT id_pizza FROM pizza WHERE pizza_name = 'Custom something 2' LIMIT 1), 3, 'NORMAL'),
(UUID(), (SELECT id_pizza FROM pizza WHERE pizza_name = 'Custom something 2' LIMIT 1), 4, 'NORMAL'),
(UUID(), (SELECT id_pizza FROM pizza WHERE pizza_name = 'Custom something 3' LIMIT 1), 2, 'NORMAL'),
(UUID(), (SELECT id_pizza FROM pizza WHERE pizza_name = 'Custom something 3' LIMIT 1), 3, 'NORMAL'),
(UUID(), (SELECT id_pizza FROM pizza WHERE pizza_name = 'Custom something 3' LIMIT 1), 4, 'NORMAL');
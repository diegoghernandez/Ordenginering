...
(1, 'Customer', 'first@names.com', '1234', '2003-10-09', '2024-2-09 20:10:12'),
...
(UUID(), 1, 'México', 'City', 'street', 4324, null, null, 98723, '2024-3-09 20:10:12');
...
(UUID(), (SELECT id_order FROM customer_order WHERE id_customer = 1 LIMIT 1), 'Custom something 3', 534, 'MEDIUM', 2, '2024-3-09 20:10:12');
